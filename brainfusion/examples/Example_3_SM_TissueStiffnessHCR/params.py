...
hcr_params = {
    ...
    "boundary_filename": "BrainBoundary",  # Choose the .txt files containing the outline coordinates
    ...
    "contour_interp_n": 200,  # Choose the number of points the contours will be interpolated to
    "clustering": "Sum"  # "GMM": Use Gaussian Mixture Model to cluster data points and create average map; "None": Use regular grid interpolation and average
}
