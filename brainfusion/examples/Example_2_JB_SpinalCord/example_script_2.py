...
base_folder = r'C:\Users\niklas\Documents\GitHub\BrainFusion\BrainFusion\examples\Example_2_JB_SpinalCord\data\SimpleTest'
...
for folder_name in os.listdir(base_folder):
    ...
    if os.path.isdir(folder_path) and ('#' in folder_name):
        ...
        corr_result = correlate_afm_myelin(afm_analysis, radius='max', verify_corr=True)
